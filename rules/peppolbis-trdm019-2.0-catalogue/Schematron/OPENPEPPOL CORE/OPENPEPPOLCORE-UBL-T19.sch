...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" schemaVersion="iso">
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:ComplementaryRelatedItem">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:ComplementaryRelatedItem' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:ContractorCustomerParty">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:ContractorCustomerParty' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:Item/cac:ItemInstance/cbc:ManufactureDate">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:ManufactureDate' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:Item/cac:ItemInstance/cbc:SerialID">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:SerialID' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:KeywordItemProperty">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:KeywordItemProperty' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:ReplacementRelatedItem">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:ReplacementRelatedItem' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity/cac:ApplicableTaxCategory">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:ApplicableTaxCategory' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity/cac:DeliveryUnit">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:DeliveryUnit' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity/cac:DependentPriceReference">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:DependentPriceReference' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity/cbc:TradingRestrictions">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:TradingRestrictions' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:CatalogueLine/cbc:LifeCycleStatusCode">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:LifeCycleStatusCode' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:SourceCatalogueReference/cbc:PreviousVersionID">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:PreviousVersionID' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="/p1:Catalogue/cac:SourceCatalogueReference/cbc:RevisionDate">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:RevisionDate' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="/p1:Catalogue/cac:SourceCatalogueReference/cbc:RevisionTime">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:RevisionTime' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:TradingTerms/cac:ApplicableAddress">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cac:ApplicableAddress' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="/p1:Catalogue/cac:TradingTerms/cbc:Reference">
            <assert flag="warning" id="PEPPOL_CORE_R002" test="true()">
	Element 'cbc:Reference' is marked as not used in the given context.</assert>
        </rule>
    </pattern>
    <pattern>
