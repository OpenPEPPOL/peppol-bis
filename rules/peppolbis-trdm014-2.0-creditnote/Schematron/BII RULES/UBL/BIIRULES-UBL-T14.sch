...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T14" id="UBL-T14">
  ...
  <param name="BII2-T14-R051" value="(xs:decimal(cbc:LineExtensionAmount)) = (xs:decimal(cbc:LineExtensionAmount)) = (round(sum((//cac:CreditNoteLine/xs:decimal(cbc:LineExtensionAmount))) * 10 * 10) div 100)"/>
