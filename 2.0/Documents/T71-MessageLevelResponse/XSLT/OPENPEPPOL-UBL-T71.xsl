...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="OPENPEPPOL  T71 bound to UBL"
                              schemaVersion="">
         <xsl:comment>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">OPENPEPPOL  T71 bound to UBL</svrl:text>
   ...
   <!--PATTERN UBL-T71-->
	...
	<!--RULE -->
<xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode" priority="1004" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:Response/cbc:ResponseCode" priority="1003" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:Status/cbc:StatusReasonCode" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:EndpointID" priority="1001" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cac:DocumentReference/cbc:DocumentTypeCode"/>
